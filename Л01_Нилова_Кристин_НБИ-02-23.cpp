...
class element
{
    public:
        double value;
        element *next; // ”казатель на следующий элемент в списке
        ...
        // ћетод дл€ вывода значени€ элемента на экран
        void print()
	    {
            cout << "value: " << value;
        }
...
class list
{
    ...
    //конструктор создает пустой указатель
		...
		//—лужебный метод дл€ вычислени€ размера списка
        ...
        element* find_by_index(int index)
        {
            ...
            return NULL; // ¬озвращает NULL, если индекс выходит за пределы списка
        }
        ...
        element* find_by_value(double value)
        {
            ...
            return NULL; // ¬озвращает NULL, если элемент с таким значением не найден
        }
...
int main()
{
	...
	l->push_back(2); //ƒобавл€ет элемент в конец списка
	l->push_front(4);//ƒобавл€ет элемент в начало списка
	l->print();//¬ывод элементов списка
	...
	// ѕример использовани€ метода find_by_index
    int index = 2;
    ...
    // ѕример использовани€ метода find_by_value
    double value = 20;
